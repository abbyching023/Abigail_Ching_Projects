...
public class updatePageObject   {
    ...
    @FindBy(xpath = "//h2[contains(.,'Update Contact')]")
    public WebElement updatePageHeader;
    ...
    public String successfulMsgLabel = "//*[contains(.,'%s')]";

    @FindBy(xpath = "//input")
    public List<WebElement> updateInputFields;
